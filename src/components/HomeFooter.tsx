        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-sm text-neutral-500 max-w-sm leading-relaxed">
              Premium custom packaging for growing businesses. Designed, printed and delivered — from your first order to your next large production run.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/store" className="hover:text-white transition-colors">Browse Products</Link></li>
              <li><Link to="/bulk-quote" className="hover:text-white transition-colors">Request Bulk Quote</Link></li>
              <li><Link to="/custom-packaging" className="hover:text-white transition-colors">Custom Packaging</Link></li>
